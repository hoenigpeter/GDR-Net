...
data_dir = osp.normpath(osp.join(PROJ_ROOT, "datasets/BOP_DATASETS/lm_5r/train_pbr"))
...
lmo_model_dir = osp.normpath(osp.join(PROJ_ROOT, "datasets/BOP_DATASETS/lm_5r/models"))
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="gen lmo random texture all egl xyz")
