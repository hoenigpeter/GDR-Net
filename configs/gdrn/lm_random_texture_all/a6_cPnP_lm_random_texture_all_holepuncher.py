...
OUTPUT_DIR = "output/gdrn/40_epochs/lm_random_texture_all_SO/holepuncher"
INPUT = dict(
    DZI_PAD_SCALE=1.5,
    TRUNCATE_FG=True,
    CHANGE_BG_PROB=0.5,
...
DATASETS = dict(
    #TRAIN=("lm_random_texture_all_pbr_holepuncher_train",),
    TEST=("lm_real_holepuncher_test",),
    DET_FILES_TEST=("datasets/BOP_DATASETS/lm_random_texture_all/test/test_bboxes/bbox_faster_all.json",),
)
