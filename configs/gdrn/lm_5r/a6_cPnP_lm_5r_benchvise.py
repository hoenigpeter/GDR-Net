...
OUTPUT_DIR = "output/gdrn/40_epochs/lm_5r_SO/benchvise"
INPUT = dict(
    DZI_PAD_SCALE=1.5,
    TRUNCATE_FG=True,
    CHANGE_BG_PROB=0.5,
...
DATASETS = dict(
    #TRAIN=("lm_5r_pbr_benchvise_train",),
    TEST=("lm_real_benchvise_test",),
    DET_FILES_TEST=("datasets/BOP_DATASETS/lm_5r/test/test_bboxes/bbox_faster_all.json",),
)
