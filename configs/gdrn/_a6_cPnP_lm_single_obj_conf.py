...
OUTPUT_DIR = "output/gdrn/40_epochs/VARIANT_SO/OBJ"
INPUT = dict(
    DZI_PAD_SCALE=1.5,
    TRUNCATE_FG=True,
    CHANGE_BG_PROB=0.5,
...
DATASETS = dict(
    #TRAIN=("VARIANT_pbr_OBJ_train",),
    TEST=("lm_real_OBJ_test",),
    DET_FILES_TEST=("datasets/BOP_DATASETS/VARIANT/test/test_bboxes/bbox_faster_all.json",),
)
