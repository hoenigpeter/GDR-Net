...
OUTPUT_DIR = "output/gdrn/40_epochs/tless_random_texture_SO/21"
INPUT = dict(
    MIN_SIZE_TRAIN=540,
    MAX_SIZE_TRAIN=720,
    MIN_SIZE_TEST=540,
...
DATASETS = dict(
    #TRAIN=("tless_random_texture_21_train_pbr",),
    TEST=("tless_21_bop_test_primesense",),
    DET_FILES_TEST=("datasets/BOP_DATASETS/tless/test/test_bboxes/yolox_tless_random_detection_priors.json",),
