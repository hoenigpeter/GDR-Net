...
class TLESS_PBR_Dataset:
    def __init__(self, data_cfg):
        ...
        self.dataset_root = data_cfg.get("dataset_root", osp.join(DATASETS_ROOT, "BOP_DATASETS/tless_100r/train_pbr"))
...
tless_model_root = "BOP_DATASETS/tless_100r/models_cad/"
################################################################################


SPLITS_TLESS_PBR = dict(
    tless_100r_train_pbr=dict(
        name="tless_100r_train_pbr",
        objs=ref.tless_100r.objects,  # selected objects
        dataset_root=osp.join(DATASETS_ROOT, "BOP_DATASETS/tless_100r/train_pbr"),
        models_root=osp.join(DATASETS_ROOT, "BOP_DATASETS/tless_100r/models_cad"),
        xyz_root=osp.join(DATASETS_ROOT, "BOP_DATASETS/tless_100r/train_pbr/xyz_crop"),
...
# single obj splits
for obj in ref.tless_100r.objects:
    for split in ["train_pbr"]:
        name = "tless_100r_{}_{}".format(obj, split)
