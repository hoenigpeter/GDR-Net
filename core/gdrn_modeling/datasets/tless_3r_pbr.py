...
tless_model_root = "BOP_DATASETS/tless_3r/models_cad/"
################################################################################


SPLITS_TLESS_PBR = dict(
    tless_3r_train_pbr=dict(
        name="tless_3r_train_pbr",
        objs=ref.tless_3r.objects,  # selected objects
...
# single obj splits
for obj in ref.tless_3r.objects:
    for split in ["train_pbr"]:
        name = "tless_3r_{}_{}".format(obj, split)
