...
tless_model_root = "BOP_DATASETS/tless_5r/models_cad/"
################################################################################


SPLITS_TLESS_PBR = dict(
    tless_5r_train_pbr=dict(
        name="tless_5r_train_pbr",
        objs=ref.tless_5r.objects,  # selected objects
...
# single obj splits
for obj in ref.tless_5r.objects:
    for split in ["train_pbr"]:
        name = "tless_5r_{}_{}".format(obj, split)
