...
class ICBIN_PBR_Dataset:
    def __init__(self, data_cfg):
        ...
        self.dataset_root = data_cfg.get("dataset_root", osp.join(DATASETS_ROOT, "BOP_DATASETS/icbin_random_texture/train_pbr"))
...
SPLITS_ICBIN_PBR = dict(
    icbin_random_texture_train_pbr=dict(
        name="icbin_random_texture_train_pbr",
        objs=ref.icbin.objects,  # selected objects
        dataset_root=osp.join(DATASETS_ROOT, "BOP_DATASETS/icbin_random_texture/train_pbr"),
        models_root=osp.join(DATASETS_ROOT, "BOP_DATASETS/icbin_random_texture/models"),
        xyz_root=osp.join(DATASETS_ROOT, "BOP_DATASETS/icbin_random_texture/train_pbr/xyz_crop"),
...
for obj in ref.icbin.objects:
    for split in ["train_pbr"]:
        name = "icbin_random_texture_{}_{}".format(obj, split)
