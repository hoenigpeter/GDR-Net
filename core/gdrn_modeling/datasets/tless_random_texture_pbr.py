...
tless_model_root = "BOP_DATASETS/tless_random_texture/models_cad/"
################################################################################
...
SPLITS_TLESS_PBR = dict(
    tless_random_texture_train_pbr=dict(
        ...
        objs=ref.tless_random_texture.objects,  # selected objects
...
# single obj splits
for obj in ref.tless_random_texture.objects:
